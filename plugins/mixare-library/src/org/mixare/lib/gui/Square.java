...
public class Square {
	 ...
	 * @param texture Texture generated by {@link Util#loadGLTexture(GL10, android.graphics.Bitmap)}
	 */
	...
	/**
	 * This method should not be called directly, use {@link Square#draw(GL10, int[])} instead
	 * @param gl The gl object supplied by onDraw
	 */
